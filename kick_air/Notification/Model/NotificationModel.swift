...
let NotificationItem = [
    ...
    NotificationModel(image: "berger",title: "New Order", message: "You have a new order", food: "Burger",time: Date(timeIntervalSinceNow: -50), isRead: true, dateString: "27 Feb 2025")
]
